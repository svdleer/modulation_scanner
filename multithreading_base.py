...
class MultithreadingBase:
    def __init__(self, config=None):
        ...
        print("REPORTING_HOST:", os.getenv('REPORTING_HOST'))
    ...
    def _decrypt_password(self, encrypted_password):
        ...
        try:
            fernet_key = self.config.get('FERNET_KEY') or os.getenv('FERNET_KEY') or 'Z4gJ36cWp4tVJXKROVzNpn_MC8OVwMJpTR_O-NIDCrw='
